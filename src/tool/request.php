...
class request
{
     ...
     * @return string
     */
    static  public function access_token_get($api_key, $secret_key)
    {
        ...
        $res       = static::_post_curl($url, $post_data);
     ...
     * @throws \Exception
     */
    static public function rebot_chat($accessToken, $payload)
    {
        ...
        $ret    = static::_post_curl($url . '?access_token=' . $accessToken, $payload2);
     ...
     * @return bool|mixed
     */
    static protected function _post_curl(string $url = '', string $param = '')
    {
