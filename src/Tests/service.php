...
try{
    ...
    $policyManager = Baidu\Iov\Kit\PolicyManagerFactory::getInstance($config_curr);
}catch ( \Baidu\Iov\Kit\Exception\UsException $e){
    echo $e->getMessage()."\n";
    exit();
}
...
$requestUnit  = new \Baidu\Iov\Kit\Request\RequestUnit();
$access_token = $requestUnit->getAccessToken($config_curr['api_key'],$config_curr['api_secret']);
...
$paras_service = new \Baidu\Iov\Kit\Request\ParasService('time',$config_curr['service_id']);
